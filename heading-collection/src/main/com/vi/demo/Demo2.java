...
public class Demo2 {
    ...
    public void findOutAllJar() {
        ...
        //String repoPath = "G:\\maven\\repository_complete";
        String repoPath = "G:\\maven\\zzkk\\repo\\p2";
        ...
        if (file1.isDirectory()) {
            ...
            for (String filename : fileNames) {
                ...
                if (childPathFile.isFile()) {
                    fileHandle(childPathFile, file1);
                } else {
    ...
    private static void fileHandle(File path, File FileParent) {
        if (path.getName().endsWith(".pom")) {
            boolean hasJar = false;
            String[] fileNames = FileParent.list();
            for (String filename : fileNames) {
            ...
            if (!hasJar) {
                ...
                copyFile(path, "E:\\eclipse-projects\\datastudio300\\DataStudio\\dest-pom\\" + jarFile);
            }
        }
    }
    ...
    private static void buildFile() {
        ...
        String cmdFile = "E:\\eclipse-projects\\datastudio300\\DataStudio\\dest-pom\\" + System.currentTimeMillis() + "-cmd.sh";
        try {
